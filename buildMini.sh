#!/bin/bash
cat src/Scaffold.js src/Sprite.js src/Button.js src/Camera.js src/Group.js src/ItemMap.js src/Loader.js src/ParticleEmitter.js src/Platform.js src/PlatformMap.js src/ProgressBar.js src/QuadTree.js src/Renderer.js src/RendererCanvas.js src/State.js src/TileMap.js src/Timer.js src/Sound.js > dist/Scaffold.cat.js
